...
public class GamePanel extends JPanel implements Runnable, ReadFromFile {
	 ...
	 * @see {@link https://www.youtube.com/watch?v=tmlZeYnfw7g} - Ambient audio
	 *      scene
	...
	public void update() {
		p.updatePlayerPosition(worldX, worldY, playerX, playerY, screenX, screenY); // updates the variable values in
																					// Player
		m.updateMapValues(worldX, worldY); // updates the variable values in Maps
